...
<div class="space-y-6">
    ...
    <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 mb-6">
        <div class="flex items-center gap-3">
            ...
            <div class="w-10 h-10 rounded-xl flex items-center justify-center" style="background: rgba(239,193,32,0.1);">
                <i class="fas fa-user-plus text-secondary-500"></i>
            </div>
            <div>
                <h1 class="text-xl font-bold text-gray-900">Ongeza Mgeni Mpya</h1>
                <p class="text-sm text-gray-500">Jaza taarifa zote za mgeni wa kanisa</p>
            </div>
        </div>
    </div>
    ...
    <div class="rx-card overflow-hidden">
        <form method="POST" action="{{ route('visitors.store') }}" class="divide-y divide-gray-100">
            @csrf
            ...
            <div class="p-6">
                <div class="flex items-center mb-6">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-500">Jaza taarifa za mtu binafsi</p>
                    </div>
                </div>
            ...
            <div class="p-6">
                <div class="flex items-center mb-6">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-500">Jaza mawasiliano na anwani</p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" id="church_from" name="church_from" value="{{ old('church_from') }}"
            ...
            <div class="p-6">
                <div class="flex items-center mb-6">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-500">Weka mtu wa kufuatilia na maelezo</p>
                    </div>
                </div>

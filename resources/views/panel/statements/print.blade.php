...
<head>
    ...
    <title>Taarifa ya Mwaka - {{ $member->first_name }} {{ $member->last_name }} - {{ $year }}</title>
    <style>
        @page {
            margin: 15mm;
            size: A4;
...
<body>
    ...
    <div class="report-title">
        <h1>TAARIFA YA MWAKA YA MICHANGO</h1>
    ...
    <div class="member-info">
        ...
        <div class="member-details">
            <div class="member-detail">
                <strong>Jina:</strong> {{ $member->first_name }} {{ $member->middle_name }} {{ $member->last_name }}
            </div>
            <div class="member-detail">
                <strong>Namba:</strong> {{ $member->member_number }}
            </div>
            <div class="member-detail">
                <strong>Simu:</strong> {{ $member->phone }}
            </div>
            <div class="member-detail">
    ...
    <div class="total-card">
        ...
        <div class="amount">{{ number_format($totalGiving, 0) }} TZS</div>
    </div>
    ...
    <!-- Grand Total -->
    <div class="total-card" style="margin-top: 30px; background: #000;">
        <div class="label">JUMLA KUU YA MICHANGO MWAKA {{ $year }}</div>
        <div class="amount">{{ number_format($totalGiving, 0) }} TZS</div>
    </div>
    ...
    <div class="report-footer">
        <p>Taarifa hii imetengenezwa kiotomatiki kwaajili ya matumizi ya ndani | {{ now()->format('d/m/Y H:i') }}</p>
    </div>

    <script>
        window.onload = function() {
            // Auto-print can be triggered by adding ?auto_print=1 to URL

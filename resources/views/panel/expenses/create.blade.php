...
@section('title', 'Ongeza Matumizi - Mfumo wa Kanisa')
@section('page-title', 'Ongeza Matumizi')
@section('page-subtitle', 'Jaza fomu hapa chini kuongeza matumizi mapya')
    ...
    <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 mb-6">
        <div>
            <div class="flex items-center gap-3 mb-2">
                ...
                <h1 class="text-3xl font-bold text-gray-900">Ongeza Matumizi Mapya</h1>
            </div>
            <p class="text-gray-600">Jaza taarifa za matumizi ya kanisa</p>
        </div>
    </div>
            ...
            <div class="p-6">
                <div class="flex items-center mb-6">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-600">Jaza taarifa za kimsingi za matumizi</p>
                    </div>
                </div>

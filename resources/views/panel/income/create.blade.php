...
@section('title', 'Ongeza Mapato - Mfumo wa E-Kanisa')
...
<div class="space-y-6">
    ...
    <div class="flex items-center gap-3 mb-2">
        ...
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Ongeza Mapato Mapya</h1>
            <p class="text-sm text-gray-500">Jaza taarifa za mapato yanayokusanywa</p>
        </div>
    </div>
        ...
        <form method="POST" action="{{ route('income.store') }}">
            ...
            <div class="p-6">
                <div class="flex items-center gap-3 mb-6">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500">Jaza taarifa za kimsingi za mapato</p>
                    </div>
                </div>
            ...
            <div class="sticky bottom-0 bg-white px-6 py-5 border-t border-gray-200 flex justify-end space-x-4 rounded-b-2xl">
                ...
                <button type="submit" class="rx-btn rx-btn-primary">
                    <i class="fas fa-save"></i> Hifadhi Mapato
                </button>
            </div>
        </form>
    </div>

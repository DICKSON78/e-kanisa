...
@section('title', 'Omba Huduma ya Kichungaji - Mfumo wa E-Kanisa')
...
<div class="space-y-6">
    ...
    <div class="flex items-center gap-3 mb-2">
        ...
        <div class="flex items-center gap-3">
            ...
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Omba Huduma ya Kichungaji</h1>
                <p class="text-sm text-gray-500">Jaza fomu ili kuomba huduma ya kichungaji</p>
            </div>
        </div>
    </div>
    ...
    <div class="rx-card rounded-2xl overflow-hidden">
        <form method="POST" action="{{ route('pastoral-services.store') }}">
            @csrf
            ...
            <div class="p-6">
                <div class="flex items-center gap-3 mb-5">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-500">Jaza taarifa za kimsingi za ombi</p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="date" name="preferred_date" value="{{ old('preferred_date') }}" min="{{ date('Y-m-d', strtotime('+1 day')) }}" class="rx-input rx-input-no-icon @error('preferred_date') !border-red-500 @enderror">
            ...
            <div class="p-6 border-t border-gray-100 bg-gray-50/50">
                ...
                <div>
                    ...
                    <textarea name="description" rows="5" class="rx-input rx-input-no-icon @error('description') !border-red-500 @enderror" placeholder="Andika maelezo zaidi kuhusu ombi lako...">{{ old('description') }}</textarea>

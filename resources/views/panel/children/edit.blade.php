...
@section('title', 'Hariri Darasa - Mfumo wa E-Kanisa')
@section('page-title', 'Hariri Darasa')
@section('page-subtitle', 'Badilisha taarifa za darasa')
...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Hariri Darasa</h1>
                <p class="text-sm text-gray-500">Badilisha taarifa za {{ $class->name }}</p>
            </div>
        </div>
        <div class="flex items-center gap-3">
            <a href="{{ route('children.show', $class->id) }}" class="rx-btn rx-btn-secondary">
    ...
    <div class="rx-card rounded-2xl overflow-hidden">
        ...
        <form action="{{ route('children.update', $class->id) }}" method="POST" class="p-6">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="number" name="age_min" id="age_min" value="{{ old('age_min', $class->age_min) }}" required min="0" max="18"
                ...
                <div>
                    ...
                    <input type="number" name="age_max" id="age_max" value="{{ old('age_max', $class->age_max) }}" required min="0" max="18"
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="description" id="description" rows="4"
                              ...
                              placeholder="Maelezo mafupi kuhusu darasa hili...">{{ old('description', $class->description) }}</textarea>
                    @error('description')
                        <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                    @enderror
                </div>
        ...
        <div class="sticky bottom-0 bg-white border-t border-gray-200 p-4">
            <div class="flex justify-end gap-3">
                ...
                <button type="submit" class="rx-btn rx-btn-primary" onclick="this.closest('form').submit();">
